...
const SAMPLE_IMAGES = [
  ...
  require('../assets/sample-images/person2.png'),
  require('../assets/sample-images/person3.jpg'),
  require('../assets/sample-images/person4.webp'),
  require('../assets/sample-images/person5.webp'),
  require('../assets/sample-images/person6.jpg'),
  require('../assets/sample-images/person7.jpg'),
  require('../assets/sample-images/person8.webp'),
];
