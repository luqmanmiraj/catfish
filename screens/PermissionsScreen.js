...
const PermissionsScreen = ({ onSignIn, onContinueAsGuest, isCreatingGuest = false }) => {
  ...
  return (
    <View style={permissionStyles.container}>
      ...
      {/* Buttons */}
      <View style={[permissionStyles.buttonContainer, { paddingBottom: Math.max(insets.bottom, 30) }]}>
        <TouchableOpacity
