        ...
        <View style={[cameraScanStyles.cameraIconContainer]}>
          <Svg width="184" height="184" viewBox="0 0 184 184" fill="none">
            ...
            <G>
              ...
              />
              {/* Gallery Icon - Image Library with mountain landscape */}
              <Path
                d="M70 68C70 66.3431 71.3431 65 73 65H111C112.657 65 114 66.3431 114 68V96C114 97.657 112.657 99 111 99H73C71.3431 99 70 97.657 70 96V68Z"
                stroke="white"
                strokeWidth="3.5"
                strokeLinecap="round"
              ...
              />
              <Path
                d="M70 75L77 81L87 75L97 81L114 71"
                stroke="white"
                strokeWidth="3.5"
                strokeLinecap="round"
                strokeLinejoin="round"
                fill="none"
              />
              <Circle cx="92" cy="78" r="3.5" fill="white" />
              <Path
                d="M77 81L72 85H70V96"
                stroke="white"
                strokeWidth="3.5"
                strokeLinecap="round"
                strokeLinejoin="round"
